...
function alpha_assets() {
	...
	if ( $launcher_template_name == "contact-page-template.php" ) {
		wp_enqueue_style( "bootstrap", "//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" );
		wp_enqueue_style( "animate-css", get_template_directory_uri() . "/assets/vendor/animate/animate.css" );
		wp_enqueue_style( "hamburgers-css",
			get_template_directory_uri() . "/assets/vendor/css-hamburgers/hamburgers.min.css" );
		wp_enqueue_style( "select2-css", get_template_directory_uri() . "/assets/vendor/select2/select2.min.css" );
